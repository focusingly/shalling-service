...
func SetDefault(db *gorm.DB, opts ...gen.DOOption) {
	*Q = *Use(db, opts...)
	...
	LoginUser = &Q.LoginUser
	MenuLink = &Q.MenuLink
	OAuthLogin = &Q.OAuthLogin
	Post = &Q.Post
...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		LoginUser:       newLoginUser(db, opts...),
		MenuLink:        newMenuLink(db, opts...),
		OAuthLogin:      newOAuthLogin(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		LoginUser:       q.LoginUser.clone(db),
		MenuLink:        q.MenuLink.clone(db),
		OAuthLogin:      q.OAuthLogin.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		LoginUser:       q.LoginUser.replaceDB(db),
		MenuLink:        q.MenuLink.replaceDB(db),
		OAuthLogin:      q.OAuthLogin.replaceDB(db),
...
type queryCtx struct {
	...
	LoginUser       ILoginUserDo
	MenuLink        IMenuLinkDo
	OAuthLogin      IOAuthLoginDo
	Post            IPostDo
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		LoginUser:       q.LoginUser.WithContext(ctx),
		MenuLink:        q.MenuLink.WithContext(ctx),
		OAuthLogin:      q.OAuthLogin.WithContext(ctx),
