...
type ICategoryDo interface {
	...
	SelectWithSorts(condList []model.WhereCond, sortList []model.SortColumn) (result []model.Category, err error)
}
...
//		{{end}}
//	{{end}}
func (c categoryDo) SelectWithSorts(condList []model.WhereCond, sortList []model.SortColumn) (result []model.Category, err error) {
